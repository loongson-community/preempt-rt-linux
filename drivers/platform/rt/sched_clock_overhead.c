/*
 *  sched_clock() Overhead Driver
 *
 *  This driver is designed for testing the overhead of sched_clock()
 */
...
static u64 loop, sum;
static unsigned int min = UINT_MAX, max, avg;
...
static inline void call_clock(int func_no)
{
	u64 t;
	struct timespec tv;
...
static void calculate_overhead(int func_no)
{
	u64 t0, t1;
	int i, overhead;
...
MODULE_DESCRIPTION("sched_clock overhead driver");
