...
#define __NR_sched_setparam_ex		(__NR_Linux + 295)
#define __NR_sched_getparam_ex		(__NR_Linux + 296)
#define __NR_sched_wait_interval	(__NR_Linux + 297)
...
#define __NR_N32_Linux_syscalls		301
