...
schedtool: schedtool.o error.o edf_syscall.o
	$(CC) $(CFLAGS) schedtool.o error.o edf_syscall.o -o schedtool
schedtool.o: schedtool.c edf_syscall.c syscall_magic.h error.h util.h edf_syscall.h
